const Footer = () => {
    return (
        <footer className="w-full">
            <div className="container flex flex-col flex-wrap px-10 py-24 mx-auto md:items-center md:flex-row md:flex-no-wrap">
                <div className="flex flex-wrap flex-grow mt-10 -mb-10 text-center md:mt-0 md:text-left justify-center">
                    <div className="w-full px-4 lg:w-1/4 md:w-1/2">
                        <a className="flex items-center justify-center font-medium text-gray-900 title-font md:justify-start">
                            <img className="w-auto h-20 text-gray-900 fill-current" src="/assets/logo/footer-logo.png" alt="Logo" />
                        </a>
                    ...
                    <div className="w-full px-4 lg:w-1/4 md:w-1/2 ">
                        <h1 className="mb-3 text-sm font-medium tracking-widest text-gray-900 uppercase title-font">Contact Info</h1>
                        <nav className="mb-10 list-none">
                            <li className="mt-3">
                                <a className="text-gray-500 cursor-pointer hover:text-gray-900">Fortich St. Malaybalay City</a>
                            </li>
                            <li className="mt-3">
                                <span className="text-gray-500">Phone: </span>
                                <a href="tel:(239) 555-0108" className="text-gray-700 cursor-pointer hover:text-gray-900">(239) 555-0108</a>
                            </li>
                            <li className="mt-3">
                            <span className="text-gray-500">Email: </span>
                                <a href="mailto: tagabukidproperty@gmail.com" className="text-gray-700 cursor-pointer hover:text-gray-900">tagabukidproperty@gmail.com</a>
                            </li>
                        </nav>
                    </div>  
                </div>
